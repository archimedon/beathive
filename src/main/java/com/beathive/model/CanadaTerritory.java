 ...
 * @hibernate.class table="canada_territory"
 */
public class CanadaTerritory extends BaseObject implements Serializable {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof CanadaTerritory)) {
            return false;
        }

        CanadaTerritory rhs = (CanadaTerritory) object;
